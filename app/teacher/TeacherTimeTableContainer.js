...
import FacultyNamesListView from './TeacherNamesListView';
import Constants from '.././utilities/Constants';
import {WebServiceCallManager} from '.././utilities/WebServiceCallManager';
import TeacherTimeTableListView from "./TeacherTimeTableListView";
const {width, height} = Dimensions.get("window");


export default class TeacherTimeTableContainer extends Component {
    ...
    constructor(props) {
        ...
        var timetable;
        if (SessionManager.getSessionValue(Constants.TEACHER_TIMETABLE) !== null) {
            timetable = SessionManager.getSessionValue(Constants.TEACHER_TIMETABLE).TimeTable;
        }
        this.state = {
    ...
    render() {
        return (
            <View>
                <TeacherTimeTableListView dataSource={this.state.dataSource}
